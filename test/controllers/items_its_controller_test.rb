...
class ItemsItsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create items_it" do
    assert_difference('ItemsIt.count') do
      post items_its_url, params: { items_it: { img: @items_it.img, site: @items_it.site, title: @items_it.title, url: @items_it.url } }, as: :json
    end
  ...
  test "should update items_it" do
    patch items_it_url(@items_it), params: { items_it: { img: @items_it.img, site: @items_it.site, title: @items_it.title, url: @items_it.url } }, as: :json
    assert_response 200
  end
